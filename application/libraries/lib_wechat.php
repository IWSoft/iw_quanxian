 ...
 *
 */
//require_once(dirname(__FILE__) . '/third_party/wechat-php-sdk/wechat.class.php');
require_once(__ROOT__.'/third_lib/wechat-php-sdk/wechat.class.php');

class lib_wechat extends Wechat {
    protected $_CI;
    public function __construct() {

        $this->_CI =& get_instance();
        //$this->_CI->config->load('wechat');
        $this->_CI->load->model('user/m_aiw_dd', 'aiw_dd');
        $options = $this->_CI->aiw_dd->get_weixin_config();//$this->_CI->config->item('wechat');
