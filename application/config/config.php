...
//是否将PHP出错信息保存在数据库表中
$config["my_save_err_to_database"] = true;//这个是自定义信息 true写入数据库 false不写数据库 但当log_threshold为1时写入文本文件
...
$config['sess_cookie_name'] = 'iwei_sess';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = "aiw_sessions";
 ...
 * ------------------------------------------------------------------------
 */
$config["def_dd_btn_guid"] = "006d4453-5466-4973-c9c4-89e2d754095b";//按钮的顶层GUID
$config["def_dd_icon_guid"] = "faa9d9d2-63c1-4b70-a03f-9147761f9cc4";//图标风格的顶层GUID
$config["def_dd_filetype"] = "1102539c-cbed-dfcb-9f15-4ec96eb3e67e";//文件类型GUID
$config["def_dd_upload_filesize"] = "2";//默认的上传文件大小
