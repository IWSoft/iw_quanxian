        ...
        <div id="toolbar" class="btn-group toolbar_my"
            ...
            if (isset($model["parent_guid"])) {
                ...
                <button class="btn btn-default btn-sm"
                        ...
                        onclick="return goback(this);"><i class="fa fa-arrow-circle-up"></i>返回上级 <?php echo $model["title"];?>
                </button>
                <?php
            }
            ?>
...
<script>
    function goback(obj) {
        ...
        window.location.href = "<?php echo site_url2("index");?>?guid=" + guid;
    }
    var $dlist;
    var add_btn_text = "";
    var edit_btn_text = "";
                ...
                , {
                    ...
                    formatter: function (value, row, index) {
                        if (row.dd_icon_style != "") {
                            value = '<i class="' + row.dd_icon_style + '"></i> ' + "<b>"+value+"</b>";
                        }
...
<script>
    //
    $("#form_a927bb94-5e91-422f-a69d-34fd108c1efe").attr("url", "<?php echo site_url2("add");?>?parent_guid=<?php echo $parent_guid;?>");
</script>